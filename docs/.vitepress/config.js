...
export default defineConfig({
  ...
  description:
    'Comprehensive guide for using NC-Scorer - Automated assessment tool for genetic variants in kidney disease',
  lang: 'en-US',
  ...
  head: [
    ...
    [
      'meta',
      {
        name: 'keywords',
        content:
          'NC-Scorer, documentation, kidney disease, genetics, variant analysis, API reference',
      },
    ],
    ...
    [
      ...
      {
        property: 'og:image',
        content: 'https://nc-scorer.kidney-genetics.org/og-image.png',
      },
    ],
    ...
    [
      'link',
      { rel: 'canonical', href: 'https://nc-scorer.kidney-genetics.org/docs/' },
    ],
  ...
  themeConfig: {
    ...
    sidebar: {
      '/guide/': [
        ...
        },
        {
          text: 'Core Concepts',
          items: [
            { text: 'Scoring System', link: '/guide/scoring-system' },
        ...
        },
        {
          text: 'Features',
          items: [
            { text: 'Search and Export', link: '/guide/usage' },
            { text: 'Batch Processing', link: '/guide/batch-processing' },
            { text: 'Logging', link: '/guide/logging-system' },
          ],
        },
      ],
      '/api/': [
        {
          ...
          items: [
            ...
            { text: 'Gene API', link: '/api/gene-api' },
            { text: 'Variant API', link: '/api/variant-api' },
    ...
    editLink: {
      pattern:
        'https://github.com/halbritter-lab/nc-scorer/edit/main/docs/:path',
  ...
  transformPageData(pageData) {
    ...
    pageData.frontmatter.head.push(
      [
        ...
        {
          property: 'og:title',
          content: pageData.title + ' | NC-Scorer Documentation',
        },
      ],
      [
        'meta',
      ...
      [
        ...
        {
          property: 'og:url',
          content: `https://nc-scorer.kidney-genetics.org/docs${pageData.relativePath.replace(/\.md$/, '.html')}`,
        },
      ],
    );
  },
